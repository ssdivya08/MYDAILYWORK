...
This repo contains my completed tasks for review.

## Task 1 - Portfolio
- A personal portfolio website showcasing my skills and projects.
-  [Task1_Portfolio](./Task1_Portfolio)
...
- A responsive quiz platform with quiz creation, listing, taking, results, and user authentication.
-  [Task3_QuizMaker](./Task3_QuizMaker)
